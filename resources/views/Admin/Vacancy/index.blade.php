...
<section>
    ...
    <div class="d-flex flex-row bd-highlight justify-content-end mb-2">
        <div>
            <button type="button" class="btn btn-success rounded-pill" onclick="window.location='{{route('vagas.create')}}'">Adicionar</button>
        </div>
    </div>
                ...
                <tr>
                    @if ($vacancy->exit_time == null)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" role="button" href="{{route('vagas.edit',$vacancy->id)}}">Saida</a>
                            </td>
                        </tr>
                    @endif
